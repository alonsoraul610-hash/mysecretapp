...
public class EditarAnuncioActivity extends AppCompatActivity {
    ...
    private String imagenActualUri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imagenActualUri = getIntent().getStringExtra("imagenUri");

        // 🔹 Mostrar datos actuales
        editDescripcion.setText(descripcion);
        editTelefono.setText(telefono);
        Glide.with(this)
                .load(imagenActualUri)
    ...
    private void guardarCambios() {
        ...
        if (imagenUriSeleccionada != null) {
            ...
            actualizarAnuncio(descripcion, telefono, imagenActualUri);
        }
    }
    ...
    private void actualizarAnuncio(String descripcion, String telefono, String imagenUri) {
        String userId = auth.getCurrentUser().getUid();
